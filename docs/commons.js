...
/***/ "./js/functions/switcher.js":
/*!**********************************!*\
  !*** ./js/functions/switcher.js ***!
  \**********************************/
/***/ (() => {

// TODO Сократить кол-во обращений к DOM
const switcher = document.querySelectorAll('.switcher__input')

switcher.forEach(el => {
    el.addEventListener('click', () => {
        document.querySelector(`#gallery-male`).classList.remove('gallery-list--show')
        document.querySelector(`#gallery-female`).classList.remove('gallery-list--show')

        const gallery = document.querySelector(`#gallery-${el.id}`)
        gallery.classList.add('gallery-list--show')
    })
})
